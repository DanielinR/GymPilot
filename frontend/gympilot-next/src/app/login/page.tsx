      ...
      <div className="flex flex-1 xl:flex-initial flex-col gap-8 items-center justify-center w-2/5 bg-color-info-back">  
        ...
        <form className="flex flex-col gap-10 items-center w-full p-2 mb-36">
          <div className="flex flex-col justify-between items-center w-full h-32">
            <LoginInput setValue={setUsername} tittle="Username" type="text" svgPath="M17.982 18.725A7.488 7.488 0 0012 15.75a7.488 7.488 0 00-5.982 2.975m11.963 0a9 9 0 10-11.963 0m11.963 0A8.966 8.966 0 0112 21a8.966 8.966 0 01-5.982-2.275M15 9.75a3 3 0 11-6 0 3 3 0 016 0z"/>
            <LoginInput setValue={setPassword} tittle="Password" type="password" svgPath="M15.75 5.25a3 3 0 013 3m3 0a6 6 0 01-7.029 5.912c-.563-.097-1.159.026-1.563.43L10.5 17.25H8.25v2.25H6v2.25H2.25v-2.818c0-.597.237-1.17.659-1.591l6.499-6.499c.404-.404.527-1 .43-1.563A6 6 0 1121.75 8.25z"/>
          </div>
