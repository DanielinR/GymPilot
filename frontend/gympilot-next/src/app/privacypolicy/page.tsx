...
export default function PrivacyPolicyPage() {
  return (
    <div className="p-7 px-10 md:p-20 md:px-32 bg-neutral-500 text-white fullheight overflow-auto">
      <h1>TERMINOS Y CONDICIONES DE POLITICA Y PRIVACIDAD GYMPILOT</h1>
      <h2>POLÍTICA DE PRIVACIDAD</h2>
      <span>
        El presente Política de Privacidad establece los términos en que
        gympilot usa y protege la información que es proporcionada por sus
      ...
      <span>
        ...
        podrán ser cancelados en cualquier momento. Gympilot está altamente
      ...
      <span>
        ...
        noticias. Usted puede aceptar o negar el uso de cookies, sin embargo la
      ...
      <span>
        ...
        requerido por un juez con un orden judicial. Gympilot Se reserva el
