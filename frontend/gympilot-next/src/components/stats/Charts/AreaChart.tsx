...
export const background = "#354146";
export const background2 = "#0D151A";
export const accentColor = "#38D1BD";
export const accentColorDark = "#0C9987";
const tooltipStyles = {
  ...defaultStyles,
  background,
        ...
        {tooltipData && (
          <div>
            <TooltipWithBounds
              ...
              style={tooltipStyles}
            >
              {`${getStockValue(tooltipData).toFixed(2)}kg`}
            </TooltipWithBounds>
            <Tooltip
